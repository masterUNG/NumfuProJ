...
class _RegisterState extends State<Register> {
  ...
  Future<Null> processInsertMySQL() async {
    ...
    String apiInsertUser =
        '${MyCostant.domain}/insertCustomer.php?isAdd=true&cust_firstname=$cust_firstname&cust_lastname=$cust_lastname&cust_phone=$cust_phone&cust_email=$cust_email&password=$password';
